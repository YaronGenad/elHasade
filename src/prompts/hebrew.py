...
def _vocabulary_word_types_note(gl: dict, grade: str) -> str:
    ...
    if min_age <= 11:
        ban = (
            "✗ מונחי ניתוח ספרותי (אלגוריה, מוטיב, קתרזיס, מטפורה, אירוניה, פרסונה, סמל, פתוס, "
            "קונפליקט כמונח ספרותי, לייטמוטיב) — אלה מושגים לכיתות י-יב בלבד.\n"
            "✗ מינוח מדעי/אקדמי שלא נמצא בטקסט עצמו (סימביוזה, אקולוגיה, פנומנולוגיה וכו׳).\n"
            "✗ מושגים פסיכולוגיים מופשטים שאינם מהטקסט."
        )
    else:
        ban = (
            "✗ אלגוריה, קתרזיס, לייטמוטיב, פתוס — אלה מושגים לכיתות י-יב.\n"
            "✗ מינוח מדעי/אקדמי שלא נמצא בטקסט עצמו."
        )
    return (
